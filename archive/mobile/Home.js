          ...
          />
            ...
            {card.facts.map((fact, index) => (
              <View key={`${card.clientId}-fact-${index}`} style={styles.factRow}>
                ...
                onLongPress={() => handleRemoveFact(card.clientId, index, false)}
                onSubmitEditing={() => {
